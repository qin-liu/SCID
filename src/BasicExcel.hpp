...
struct CODE
{
	enum {	FORMULA=0x0006,		//Token array and the result of a formula cell.
			...
			eSTRING=0x0207,		//Result of a string formula.
...
struct LargeString
{
	...
	void Reset();
	size_t Read(const char* data, size_t size = 0);
	...
	size_t stringSize; //add by xujianhui
...
public:
	enum {UNDEFINED, INT, eDOUBLE, eSTRING, WSTRING};
